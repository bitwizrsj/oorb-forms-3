          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-2 px-4 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition-colors shadow-sm min-h-[44px]"
              >
          ...
          <form className="mt-8 space-y-6" onSubmit={handleVerifyOTP}>
            ...
            <div>
              ...
              <input
                ...
                className="mt-2 block w-full px-3 py-4 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 text-2xl tracking-[1em] text-center font-bold"
                placeholder="000000"
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                disabled={loading}
                className="w-full text-sm font-medium text-blue-600 hover:text-blue-500 disabled:text-gray-400"
              >
